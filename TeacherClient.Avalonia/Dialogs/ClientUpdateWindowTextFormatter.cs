...
internal static class ClientUpdateWindowTextFormatter
{
    internal static string BuildProgressDetails(TeacherClientUpdateProgress progress)
    {
    ...
    internal static string BuildLogMessage(TeacherClientUpdateProgress progress)
    {
