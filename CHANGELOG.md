...
- Both teacher clients now expose a dedicated `Group Commands` menu for teacher-side multi-agent actions against configured student folders and work folders.
